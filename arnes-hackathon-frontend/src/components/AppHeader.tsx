...
const AppHeader = () => {
    ...
    return (
        <header
            className="h-[3.75rem] border-b border-border bg-card flex items-center justify-between px-5 shrink-0"
            role="banner"
        >
            <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-primary/25 bg-primary/10 text-primary shadow-sm">
                ...
                <h1 className="text-3xl font-bold tracking-tight text-foreground leading-none">
                    ...
                    >
                        <span className="text-primary">KUL</span>TURKO
                    </button>
                </h1>
            </div>
            <div className="flex items-center gap-3">

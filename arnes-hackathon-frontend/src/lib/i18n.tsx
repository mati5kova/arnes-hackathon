    ...
    en: {
        ...
        capabilities: {
            ...
            current: [
                ...
                "Site detail dialog with registry metadata, coordinates, and tell-me-more shortcuts.",
                "AI assistant with model selection, cited answers, and heritage-focused explanations.",
                "Shareable URL state for current map area, zoom, search term, and active overlay.",
            ],
            comingSoon: [
                "Clearer visual summaries of corrected hazard values directly inside the site dialog.",
                "Broader export and reporting flows for municipal and regional reviews.",
                "Historical trend views and scenario-based projections.",
                "Deployment-ready operational dashboards for usage and reliability.",
            ],
            needsWork: [
                ...
                "Role-based collaboration and structured reporting workflows.",
            ],
        },
        chat: {
            ...
            newChat: "New chat",
            resetConversationAria: "Start a new chat",
        ...
        siteDialog: {
            ...
            hazardComparisonTitle: "Hazard assessment",
            hazardOriginal: "Original",
            hazardEnriched: "Enriched",
            hazardFlood: "Flood",
            hazardFire: "Fire",
            hazardLandslide: "Landslide",
            hazardEarthquake: "Earthquake",
            explainAction: "Tell me more",
        },
        notFound: {
    ...
    sl: {
        ...
        capabilities: {
            ...
            current: [
                ...
                "Pogovorno okno s podrobnostmi lokacije, registrskimi metapodatki, koordinatami in bližnjico za dodatne informacije lokacije.",
                "AI pomočnik z izbiro modela, citiranimi odgovori in razlago enot dediščine.",
                "Deljivo stanje URL-ja za trenutno območje zemljevida, povečavo, iskalni niz in aktivni sloj.",
            ],
            comingSoon: [
                "Jasnejši vizualni povzetki popravljenih ocen nevarnosti neposredno v pogovornem oknu lokacije.",
                "Širši izvozni in poročevalski tokovi za občinske in regijske preglede.",
                "Pogledi zgodovinskih trendov in projekcije po scenarijih.",
                "Operativne nadzorne plošče za uporabo in zanesljivost pred produkcijo.",
            ],
            needsWork: [
                ...
                "Sodelovanje po vlogah ter strukturirana izvozna in poročevalska opravila.",
            ],
        },
        chat: {
            ...
            sourcesLabel: "Viri",
            newChat: "Nov pogovor",
            resetConversationAria: "Začni nov pogovor",
        ...
        siteDialog: {
            ...
            hazardComparisonTitle: "Ocene nevarnosti",
            hazardOriginal: "Originalna",
            hazardEnriched: "Obogatena",
            hazardFlood: "Poplave",
            hazardFire: "Požar",
            hazardLandslide: "Plazovi",
            hazardEarthquake: "Potres",
            explainAction: "Povej mi več",
        },
        notFound: {
